...
#if (0) /* SD Ver */
  printf("\n\r");
//	printf("Integer Fully_connected Time %d.%03d[s]", (int)ms_total/1000, (int)(ms_total-(ms_total/1000)*1000));
	printf("Integer Fully_connected Time %d.%03d[ms]", (int)us_total/1000, (int)(us_total-(us_total/1000)*1000));
   printf("\n\r");
#endif
