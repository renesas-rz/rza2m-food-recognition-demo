...
//  PerformInit();
  ...
  PerformSetEndTime(1);
  us_total  = PerformGetElapsedTime_us(1);

  printf("\n\r");
//	printf("Float32 Softmax         Time %d.%03d[s]", (int)ms_total/1000, (int)(ms_total-(ms_total/1000)*1000));
	printf("Float32 Softmax         Time %d.%03d[ms]", (int)us_total/1000, (int)(us_total-(us_total/1000)*1000));
   printf("\n\r");
...
#if (0) /* SD Ver */
  printf("\n\r");
//	printf("Integer Softmax         Time %d.%03d[s]", (int)ms_total/1000, (int)(ms_total-(ms_total/1000)*1000));
	printf("Integer Softmax         Time %d.%03d[ms]", (int)us_total/1000, (int)(us_total-(us_total/1000)*1000));
   printf("\n\r");
#endif
