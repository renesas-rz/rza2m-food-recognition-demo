...
Macro definitions
******************************************************************************/
#define     R_BCD_LCD0_WIDTH     (256u)
#define     R_BCD_LCD0_HEIGHT    (256u)
#define     R_BCD_LCD0_STRIDE    (4u)

#define     R_BCD_LCD2_WIDTH     (640u)
#define     R_BCD_LCD2_HEIGHT    (480u)
#define     R_BCD_LCD2_STRIDE    (4u)

#define     LAYER0_DISP_AREA_HS         (64u)
#define     LAYER0_DISP_AREA_VS         (32u)
#define     LAYER0_DISP_AREA_HW         (R_BCD_LCD0_WIDTH)
#define     LAYER0_DISP_AREA_VW         (R_BCD_LCD0_HEIGHT)

#define     VIDEO_BUFFER_STRIDE         ((LAYER0_DISP_AREA_HW + (R_BCD_LCD0_STRIDE - 1)) & ~(R_BCD_LCD0_STRIDE - 1))
...
#define     LAYER2_DISP_AREA_HW         (R_BCD_LCD2_WIDTH)
#define     LAYER2_DISP_AREA_VW         (R_BCD_LCD2_HEIGHT)

#define     GRAPHICS2_BUFFER_STRIDE     (((LAYER2_DISP_AREA_HW / 2) + (R_BCD_LCD2_STRIDE - 1)) & ~(R_BCD_LCD2_STRIDE - 1))
#define     GRAPHICS2_BUFFER_HEIGHT     (LAYER2_DISP_AREA_VW)
#define     GRAPHICS2_BUFFER_NUM        (2u)

#define     GS_FRAME_BYTE_PER_PIXEL     (4u)  /* ARGB8888 is 4,  RGB565 is 2 */
#define     GS_FRAME_WIDTH              (256u)
#define     GS_FRAME_HEIGHT             (256u)
...
******************************************************************************/
static uint8_t video_buffer[VIDEO_BUFFER_NUM][(VIDEO_BUFFER_STRIDE * VIDEO_BUFFER_HEIGHT * 4)] __attribute__ ((section("Video_RAM")));
...
int32_t R_BCD_LcdInit(void)
{
    ...
    if (error == VDC_OK)
    {
        ...
        line_num = LCD_CH0_DISP_VS + R_BCD_LCD0_HEIGHT;
    ...
    if (error == VDC_OK)
    {
        ...
        gr_disp_cnf.fb_stride = GS_FRAME_WIDTH * GS_FRAME_BYTE_PER_PIXEL;
        ...
        gr_disp_cnf.read_format   = VDC_GR_FORMAT_ARGB8888; /* Read Format                */
...

    {
        ...
        /* buffer claer */
        DrawRectFill( VDC_LAYER_ID_2_RD, 0 ,0, R_BCD_LCD2_WIDTH, R_BCD_LCD2_HEIGHT, TRANSPARENT );
    }
