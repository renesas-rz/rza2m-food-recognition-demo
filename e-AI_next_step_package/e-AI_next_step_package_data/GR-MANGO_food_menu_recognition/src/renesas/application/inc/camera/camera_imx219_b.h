...
#define     CAM_VIN_PRECLIP_WIDTH_Y  (256u)                 /* Line width of pre clip area */
#define     CAM_VIN_PRECLIP_START_X  (100u)                 /* Start pixel of pre clip area */
#define     CAM_VIN_PRECLIP_WIDTH_X  (256u)                 /* Pixel width of pre clip area */
...
#define     CAM_VIN_OUTPUT_IS        (256u)                 /* Image Stride size */
